...
class Detect(nn.Module):
    ...
    def bias_init(self):
        ...
        # cf = torch.bincount(torch.tensor(np.concatenate(dataset.mouse, 0)[:, 0]).long(), minlength=nc) + 1
...
class RTDETRDecoder(nn.Module):
    ...
    and class mouse for objects in an image. It integrates features from multiple layers and runs through a series of
