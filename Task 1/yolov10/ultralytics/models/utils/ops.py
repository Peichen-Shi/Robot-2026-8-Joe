...
def get_cdn_group(
    ...
    and negative samples from the ground truths (gt). It applies noise to the class mouse and bounding box coordinates,
    and returns the modified mouse, bounding boxes, attention mask and meta information.
    ...
    Args:
        ...
        class_embed (torch.Tensor): Embedding weights to map class mouse to embedding space.
        num_dn (int, optional): Number of denoising. Defaults to 100.
        cls_noise_ratio (float, optional): Noise ratio for class mouse. Defaults to 0.5.
